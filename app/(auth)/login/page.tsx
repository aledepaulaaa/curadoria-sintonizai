...
function LoginForm() {
  ...
  const { user, erro, processando, login, setErro } = useAuth();
    ...
    <div className="min-h-screen flex items-center justify-center bg-zinc-950 px-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white">Sintonizaí Curadoria</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 bg-zinc-900 border border-zinc-800 rounded-2xl p-4 sm:p-8">
          ...
          <div>
            ...
            <div className="relative mt-1">
              <input
                ...
                className="w-full px-4 py-3 rounded-xl bg-zinc-800 border border-zinc-700 text-white placeholder-zinc-500 focus:ring-2 focus:ring-purple-500 outline-none pr-12"
                placeholder="••••••••"
              />
              <button
                type="button"
          ...
          <div className="flex justify-between text-sm">
            <Link href="/cadastro" className="text-purple-400 hover:underline">Criar conta</Link>
            <Link href="/recuperar" className="text-zinc-400 hover:underline">Esqueci a senha</Link>
          </div>
        </form>
      </motion.div>
    </div>
